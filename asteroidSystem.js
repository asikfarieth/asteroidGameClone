...
//     if (typeof this.accelerations[i] == 'undefined' || typeof this.velocities[i] == 'undefined' || typeof this.locations[i] == 'undefined' || typeof this.diams[i] == 'undefined' ){
//       console.log('true');
//     }
  }
  }
  ...
  spawn() {
    ...
    // if (this.time > 1200 && this.time <= 2600) {
